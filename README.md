...
Предыдущие три графика отображают незначительные изменения во времени работы с крайними элементами листа в зависимости от количества элементов в нем (погрешность работы процессора). Это доказывает очевидный факт константного времени работы листа с первым и последним элементом (а также константное время добавления в начало и конец).
