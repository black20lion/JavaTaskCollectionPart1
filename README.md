...
1) Реализация MyLinkedList оказалось сопоставима по производительности со стандартной коллекцей, методы были реализованы похожим образом, собственную коллекцию также можно использовать для хранения объектов любого типа.
