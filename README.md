...
4) Ситуация с имплементациями интерфейса Map схожа - TreeMap по некоторым причинам оказался быстрее всех в добавлении элементов, LinkedHashMap оказался медленнее всех. Удаление элементов выполнилось за примерно одинаковое время.
